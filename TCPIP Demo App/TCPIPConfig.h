...
#define STACK_USE_UART2TCP_BRIDGE2		// 自定义串口转以太网桥
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(2506ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			#ifdef STACK_USE_UART2TCP_BRIDGE2
			{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_ETH_RAM, 128, 128},
            #endif
			...
			{TCP_PURPOSE_CMD_SERVER0,TCP_ETH_RAM,80,80},
			{TCP_PURPOSE_CMD_SERVER1,TCP_ETH_RAM,80,80},
